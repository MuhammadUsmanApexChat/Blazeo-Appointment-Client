...
import {
  ...
  type FrontendCalendarView,
} from "./mapToFrontendCalendarView.js";
...
export async function fetchCalendarBundle(
  calendarId: string,
  connection?: { baseUrl?: string; consumer?: string; viewFormat?: "frontend" | "unified" }
